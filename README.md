...
Los siguientes variables de entorno deben estar definidas en el archivo `.Renviron` antes de usar el paquete;
y se cargarán automáticamente al iniciar una sesión de R:

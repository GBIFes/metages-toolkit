...
-- Descripción: Numero de colecciones por subdisciplina botanica
--              
-- Base de datos: gbif_wp
-- Vista: colecciones_por_subdisciplina_botanica
-- ===================================================================


-- CREATE OR REPLACE VIEW colecciones_por_subdisciplina_botanica AS

...
-- Descripción: Numero y porcentaje de ejemplares informatizados en las colecciones botanicas
--              
-- Base de datos: gbif_wp
-- Vista: colecciones_informatizacion_ejemplares_bot
-- ===================================================================


-- CREATE OR REPLACE VIEW colecciones_informatizacion_ejemplares_bot AS

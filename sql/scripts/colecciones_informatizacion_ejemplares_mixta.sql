...
-- Descripción: Numero y porcentaje de ejemplares informatizados en las colecciones mixtas
--              
-- Base de datos: gbif_wp
-- Vista: colecciones_informatizacion_ejemplares_mixta
-- ===================================================================


-- CREATE OR REPLACE VIEW colecciones_informatizacion_ejemplares_mixta AS

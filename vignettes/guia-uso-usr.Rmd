...
> Tener en cuenta que la funcion `extraer_colecciones_mapa.R` filtra MetaGES para proveer **registros de calidad**. Por lo tanto no proporciona la lista completa de registros de colecciones y bases de datos de MetaGES. Para acceder a todos los datos de MetaGES, acceder [Mediante llamadas SQL a MetaGES](https://gbifes.github.io/metages-toolkit/articles/guia-uso-dev.html#mediante-llamadas-sql-a-metages)

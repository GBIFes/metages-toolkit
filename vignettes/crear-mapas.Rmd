...
mediante la función `extraer_colecciones_mapa()`.
...
Ejemplo de uso de `crear_mapa_simple(tipo_coleccion = "base de datos", facet = "disciplina_def", publican = F)`, mostrando la distribución
espacial de los recursos del Registro, facetada por disciplina.

...
crear_mapa <- function(data = data, disci = NULL, publican = NULL){
  ...
  data_clean %>%
    ...
    scale_color_viridis_c(
      ...
      breaks = mybreaks, limits = limits, name = "Numero de ejemplares"
    ) +
    ...
    labs(
      ...
      subtitle = paste(
        c(
          if (!is.null(disci)) paste0("Disciplina: ", disci) else NULL,
...
crear_mapa(data, disci = "Zoológica")
crear_mapa(data, disci = "Botánica")
crear_mapa(data, disci = "Paleontológica")
crear_mapa(data, disci = "Micológica")
crear_mapa(data, disci = "Mixta")
crear_mapa(data, disci = "Microbiológica")

crear_mapa(data, disci = "Zoológica", publican = T)
crear_mapa(data, disci = "Botánica", publican = T)
crear_mapa(data, disci = "Paleontológica", publican = T)
crear_mapa(data, disci = "Micológica", publican = T)
crear_mapa(data, disci = "Mixta", publican = T)
crear_mapa(data, disci = "Microbiológica", publican = T)

crear_mapa(data, disci = "Micológica", publican = F)
crear_mapa(data, disci = "Mixta", publican = F)
crear_mapa(data, disci = "Microbiológica", publican = F)
